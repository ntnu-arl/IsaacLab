...
class MultirotorData:
    ...
    This class defines the state shared by the backend-specific articulation data containers,
    including multirotor thruster states, thrust targets, and computed forces.
